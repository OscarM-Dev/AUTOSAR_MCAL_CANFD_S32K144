...
*/
#define SpiConf_SpiChannel_Spi1Cs3_Control    ((Spi_ChannelType)0)
#define SpiConf_SpiChannel_Spi1Cs3_Data    ((Spi_ChannelType)1)
...
*     for all the driver configurations.
*/
#define SpiConf_SpiJob_Spi1Cs3_W_R_Job   ((Spi_JobType)0)
...
*     for all the driver configurations.
*/
#define SpiConf_SpiSequence_Spi1Cs3_Sequence_W_R   ((Spi_SequenceType)0)
...
*/
#define SPI_Conf0Spi1Cs3  ((Spi_ExternalDeviceType)0u)
