...
/* External device Configuration of Conf0Spi1Cs3*/
static const Spi_ExternalDeviceConfigType Spi_ExternalDeviceConfig_Conf0Spi1Cs3 =
{
        /* Conf0Spi1Cs3*/
        ...
        {   /* ExternalDeviceConfig */
            &Lpspi_Ip_DeviceAttributes_Conf0Spi1Cs3 /* LPSPI ExternalDeviceConfig */
...
const Spi_ExDevicesConfigType Spi_aExternalDeviceConfigList[1U] =
{
    {
    /* Conf0Spi1Cs3 */
    &Spi_ExternalDeviceConfig_Conf0Spi1Cs3
    }
};

/* Hardware Unit configuration for SPI1 */
static const Spi_HWUnitConfigType Spi_HwUnitConfig_SPI1 =
{
        SPI_OVER_LPSPI, /* IpType */
        (uint8)1U, /* Instance */
        SPI_SPURIOUS_CORE_ID_U32, /* SpiCoreUse */
        {
            &Lpspi_Ip_PhyUnitConfig_SPI1 /* LPSPI IpConfig */
#if (SPI_IPW_SPI_FLEXIO_ENABLE == STD_ON)
