...
#include "Spi_MemMap.h"
/* Lpspi_Ip_DeviceAttributes_Conf0Spi1Cs3 Device Attribute Configuration of Spi*/
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_Conf0Spi1Cs3 =
{
    1U,  /* Instance */
        (uint32)(LPSPI_CCR_SCKPCS(7U) | LPSPI_CCR_PCSSCK(7U) | LPSPI_CCR_SCKDIV(6U) | LPSPI_CCR_DBT(6U)), /* CCR */
        /* Normal Mode TCR */
...
const Lpspi_Ip_ConfigType Lpspi_Ip_PhyUnitConfig_SPI1 =
{
    1U,  /* Instance */
    /* CR */
    (uint32)0,
